#!/bin/sh
#==========================================================================
# Makedeb file for ObTools Database libraries.
#
...
install -m 0644 $SRC_DIR/ot-db-pgsql.a $DEB_DEV/usr/lib/obtools/
install -m 0644 $SRC_DIR/ot-db-pgsql-single.a $DEB_DEV/usr/lib/obtools/
install -m 0644 $SRC_DIR/ot-db.h $DEB_DEV/usr/include/obtools/
install -m 0644 $SRC_DIR/ot-db-pgsql.h $DEB_DEV/usr/include/obtools/
